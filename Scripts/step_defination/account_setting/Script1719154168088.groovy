...
WebUI.callTestCase(findTestCase('account_setting/click_button_user'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('account_setting/click_button_account_setting'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('account_setting/input_new_username'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('account_setting/click_save_changes'), [:], FailureHandling.STOP_ON_FAILURE)
